...
public class FeaturesExample {
    ...
    void test() throws IOException, DuplicateKeyException, DYReaderException, IllegalListException, NotLoadedException, IllegalKeyException, DYWriterException {
        ...
        yaml.put("or separation by spaces").setDefValues(new DYValueContainer("great!").setComment("side-comments supported!"));
        ...
        yaml.put("m1-g0", "m2-g1")
                .addDefValues(new DYValueContainer("v1").setComment("This is a side-comment in a list"))
                .addDefValues(new DYValueContainer("v2").setComment("This is also a side-comment, for the value below"));
