...
public class ParentExample {
    ...
    void test() throws Exception {
        ...
        DYModule p1C1 = yaml.put("p1", "c1").setDefValue("You can arrange your");
        DYModule p1C2 = yaml.put("p1", "c2").setDefValue("keys and values");
        DYModule p1C3 = yaml.put("p1", "c3").setDefValue("as you like!");
        DYModule p2C3 = yaml.put("p2", "c1", "c2", "c3").setDefValue("awesome!"); // Always order objects from parent to child, otherwise you will get errors!
        ...
        DYModule p3C1 = yaml.put("p3", "c1").setDefValue("v1");
        DYModule p3C2 = yaml.put("p3", "c1", "c2").setDefValue("v2");
        DYModule p3C3 = yaml.put("p3", "c1", "c2", "c3").setDefValue("v3");
